...
void place_particles(vector<particle_t> *particle_bins, particle_t *particles, int number_of_particles, omp_lock_t* bin_writelock){
...
{   
	...
	dmin = 1.0;
		...
		place_particles(particle_bins, particles, n, &bin_writelock);
