...
{    
    ...
    local.resize(nlocal);
    MPI_Scatterv( particles, partition_sizes, partition_offsets, PARTICLE, &local[0], nlocal, PARTICLE, 0, MPI_COMM_WORLD );
    ...
    for( int step = 0; step < NSTEPS; step++ )
    {
        ...
        //
        MPI_Allgatherv( &local[0], nlocal, PARTICLE, particles, partition_sizes, partition_offsets, PARTICLE, MPI_COMM_WORLD );
